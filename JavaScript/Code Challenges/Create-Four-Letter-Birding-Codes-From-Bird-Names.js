...
function birdCode(arr){
  let code = arr.slice().map(e => {
    let value = e.toUpperCase().split(/[- ]/);
    switch (value.length) {
      case 1: return value[0].substring(0,4);
      case 2: return value[0].substring(0,2) + value[1].substring(0,2);
      case 3: return value[0][0] + value[1][0] + value[2].substring(0,2);
      case 4: return value[0][0] + value[1][0] + value[2][0] + value[3][0];
    }
  })
  return code;
}